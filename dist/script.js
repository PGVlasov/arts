...
/* harmony import */ var _modules_scrilling__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/scrilling */ "./src/js/modules/scrilling.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_scrilling__WEBPACK_IMPORTED_MODULE_11__["default"])(".pageup");
...
var filter = function filter() {
  ...
  var mrkAll = wrapper.querySelectorAll(".all");
  var mrkGirl = wrapper.querySelectorAll(".girl");
  var mrkLovers = wrapper.querySelectorAll(".lovers");
  var mrkChef = wrapper.querySelectorAll(".chef");
  var mrkGuy = wrapper.querySelectorAll(".guy");
  var no = document.querySelector(".portfolio-no");

  var typeFilter = function typeFilter(markType) {
    mrkAll.forEach(function (mark) {
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      statusImg.classList.add("animated", "fadeOutUp");
...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener("scroll", function () {
      if (!btnPresed && window.pageYOffset + document.documentElement.clientHeight >= document.documentElement.scrollHeight) {
...
var scrolling = function scrolling(upSelector) {
  ...
  var smoothScroll = function smoothScroll(from, to, hash) {
    ...
    var move = setInterval(function () {
      ...
      if (priviusScrollTop === scrollTop || to > from && scrollTop >= t0 || to < from && scrollTop <= to) {
        clearInterval(move);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener("click", function () {
    Object(_servises_requests__WEBPACK_IMPORTED_MODULE_3__["getResourse"])("assets/db.json").then(function (res) {
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  function activateAnimation() {
    if (dir === "vertical") {
      paused = setInterval(function () {
        plusSlides(1), items[slideIndex - 1].classList.add("slideInDown");
      }, 3000);
    } else {
      paused = setInterval(function () {
        plusSlides(1), items[slideIndex - 1].classList.remove("slideInRight");
        items[slideIndex - 1].classList.add("slideInLeft");
      }, 3000);
    }
  }
  ...
  activateAnimation();
  items[0].parentNode.addEventListener("mauseenter", function () {
    clearInterval(paused);
  });
  items[0].parentNode.addEventListener("mauseleave", function () {
    activateAnimation();
  });
};
